package com.github.rzabini.expect
 ...
 *
 * @author Ronnie Dong
 * @version 1.1* @author Romano Zabini
...
public class Expect {
    ...
    public Expect(ChannelShell channelShell) {
        this(channelShell.getInputStream(), channelShell.getOutputStream())
        this.channelShell = channelShell
        channelShell.connect()
    }

    private Expect(InputStream input, OutputStream output) {
        try {
    ...
    static of(ChannelShell channelShell, Closure closure) {
        new Expect(channelShell).execute(closure)
     ...
     * @throws java.io.IOException* most unlikely
     *
     */
     ...
     * @throws java.io.IOException* when there is a problem reading from the InputStream
